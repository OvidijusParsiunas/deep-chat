...
export class FocusUtils {
  public static focusEndOfInput(inputElement: HTMLElement) {
    ...
    // On mobile devices and Safari, we need to explicitly focus to ensure the virtual keyboard stays active
    if (Browser.IS_MOBILE || Browser.IS_SAFARI) inputElement.focus();
  }
  ...
  public static focusFromParentElement(parentElement: HTMLElement) {
    ...
    if (inputElement) FocusUtils.focusEndOfInput(inputElement);
  }
}
