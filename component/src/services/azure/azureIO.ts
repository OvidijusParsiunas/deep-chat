...
export class AzureIO extends BaseServideIO {
  ...
  introPanelMarkUp = `
    ...
    <p>
      Click <a href="${AzureIO.HELP_LINK}">here</a> for more info.
    </p>`;
  ...
  constructor(aiAssistant: AiAssistant, key?: string) {
    ...
    super(aiAssistant, config, AzureUtils.buildKeyVerificationDetails(config.region), AzureUtils.buildHeaders, key);
    Object.assign(this._raw_body, config);
    this._raw_body.outputFormat ??= 'audio-16khz-128kbitrate-mono-mp3';
