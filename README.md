...
Setting up your own server is made easy using the following [server templates](https://deepchat.dev/examples/servers). From creating your own service to establishing proxies for other APIs such as OpenAI, everything is documented with clear examples to get you up and running in seconds:
...
All examples are ready to be deployed to a hosting platform such as [Vercel](https://vercel.com/).
