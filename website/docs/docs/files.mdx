...
- Type: {[`request?: Request`](./service#Request), [`files?: FileAttachments`](#FileAttachments), [`button?: Button`](./sharedTypes#Button)}
...
- Type: {<br />
  ...
  &nbsp;&nbsp;&nbsp;&nbsp; [`modalContainerStyle?: CustomStyle`](./sharedTypes#CustomStyle) <br />
  }
