...
<ComponentContainer>
  <DeepChatBrowser
    ...
    initialMessages={[{file: {src: '/img/example-gif.gif', type: 'image'}, role: 'user'}]}
    directConnection={{demo: true}}
    gifs={true}
  ></DeepChatBrowser>
</ComponentContainer>
...
Configuration for the drag and drop functionality. If any of the above properties are defined or you have defined a service in the [`directConnection`](./directConnection) property which allows file uploads -
...
- Type: {[`request?: Request`](./connect#Request), [`files?: FileAttachments`](#FileAttachments), [`button?: Button`](./styles#Button)}
...
- Type: {<br />
  &nbsp;&nbsp;&nbsp;&nbsp; [`request?: Request`](./connect#Request), <br />
...
:::info
The use of this object will automatically disable the `speechToTextInput` functionality.
:::
