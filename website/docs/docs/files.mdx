...
<ComponentContainer>
  <DeepChatBrowser
    ...
    initialMessages={[{file: {src: '/img/city.jpeg', type: 'image'}, role: 'user'}]}
...
This property can be set with a boolean _true_ or configured with a [`FilesServiceConfig`](#FilesServiceConfig) object.
    ...
    initialMessages={[{file: {src: '/img/demon-slayer-kimetsu-no-yaiba.gif', type: 'image'}, role: 'user'}]}
...
<ComponentContainer>
  <DeepChatBrowser
    ...
    initialMessages={[
      {
        file: {src: '/img/hiii-everyone-i-made-a-local-deforum-stable-diffusion-ver-v0-xn1e7x9k9mn91.gif', type: 'image'},
        role: 'user',
      },
    ]}
    existingService={{demo: true}}
...
<ComponentContainer>
  <DeepChatBrowser
    ...
    initialMessages={[{file: {src: '/img/cat.jpg', type: 'image'}, role: 'user'}]}
    existingService={{demo: true}}
    camera={true}
  ></DeepChatBrowser>
</ComponentContainer>
...
<ComponentContainer>
  <DeepChatBrowser
    ...
    initialMessages={[{file: {src: '/audio/cantinaBand.wav', type: 'audio'}, role: 'user'}]}
    existingService={{demo: true}}
    audio={true}
  ></DeepChatBrowser>
</ComponentContainer>
...
<ComponentContainer>
  <DeepChatBrowser
    ...
    initialMessages={[{file: {src: '/audio/jeff.mp3', type: 'audio'}, role: 'user'}]}
    existingService={{demo: true}}
    microphone={true}
  ></DeepChatBrowser>
</ComponentContainer>
...
<ComponentContainer>
  <DeepChatBrowser
    ...
    initialMessages={[{file: {src: '/text/text.txt', name: 'text-file.txt', type: 'file'}, role: 'user'}]}
    existingService={{demo: true}}
    mixedFiles={true}
  ></DeepChatBrowser>
</ComponentContainer>
...
- Type: `boolean` | [`CustomStyle`](./styles#CustomStyle)
- Default: _false_

Configuration for the drag and drop functionality. If any of the above properties are defined or you have defined an [`existingService`](./existingServices) that allows file uploads -
...
_".png,.jpg"_ in [`images`](./files#images) are the only file types allowed, a dropped _.txt_ file will not be accepted.
...
- Type: {[`request?: Request`](./service#Request), [`files?: FileAttachments`](#FileAttachments), [`button?: Button`](./styles#Button)}
...
- Type: {`textMarkDown: string`, `openModalOnce?: boolean`, [`containerStyle?: CustomStyle`](./styles#CustomStyle)}
...
- Type: {<br />
  &nbsp;&nbsp;&nbsp;&nbsp; [`request?: Request`](./service#Request), <br />
  &nbsp;&nbsp;&nbsp;&nbsp; [`files?: CameraFiles`](#CameraFiles), <br />
  &nbsp;&nbsp;&nbsp;&nbsp; [`button?: Button`](./styles#Button), <br />
  &nbsp;&nbsp;&nbsp;&nbsp; [`modalContainerStyle?: CustomStyle`](./styles#CustomStyle) <br />
  }
...
- Type: {<br />
  ...
  &nbsp;&nbsp;&nbsp;&nbsp; [`button?: MicrophoneStyles`](./styles#MicrophoneStyles) <br />
  }
...
:::info
The use of this object will automatically disable the [`speechToTextInput`](WORK) functionality.
:::
