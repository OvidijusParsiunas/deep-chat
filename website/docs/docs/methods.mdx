...
By default the [`submitButton`](./styles#submitButtonStyles) automatically enables and disables itself based on the user's input
or the [websocket](./connect#Websocket) connection. This method overrides this behaviour and allows you to disable it manually.
