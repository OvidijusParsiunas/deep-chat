...
Please see [`EXAMPLES`](https://github.com/OvidijusParsiunas/deep-chat/tree/main/other-packages/servers) for setting up your own server.
...
can stream your messages into the chat. (Please see [`examples`](https://github.com/OvidijusParsiunas/deep-chat/tree/main/other-packages/servers) on how to set up a server).
