...
<ComponentContainer>
  <AiAssistantBrowser
    initialMessages={[
      ...
      {file: {url: '/img/city.jpeg', type: 'image'}, role: 'ai'},
...
<ComponentContainer>
  <AiAssistantBrowser
    initialMessages={[
      ...
      {file: {url: '/audio/cantinaBand.wav', type: 'audio'}, role: 'user'},
      {file: {url: '/text/text.txt', name: 'hello-world.txt', type: 'file'}, role: 'user'},
    ]}
    service={{custom: {demo: true}}}
  ></AiAssistantBrowser>
</ComponentContainer>
