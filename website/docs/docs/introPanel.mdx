...
to the CSS classes and JavaScript in your app. To get around this, we recommend using the [`htmlClassUtilities`](./messages/HTML#htmlClassUtilities) property
...
services in the [`directConnection`](./directConnection) property.
