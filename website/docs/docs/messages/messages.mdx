...
`html` is used to render custom code - [more info](/docs/html).
...
- Type: {[`role: MessageRole`](#MessageRole), `text?: string`, [`files?: MessageFile[]`](#MessageFile), [`html?: string`](/docs/HTML)}
