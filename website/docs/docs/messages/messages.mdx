...
- Type: <br />
  ...
  &nbsp;&nbsp;&nbsp;&nbsp; | {[`role: MessageRole`](#MessageRole), [`file: MessageFile`](#MessageFile)} <br />
  &nbsp;&nbsp;&nbsp;&nbsp; | {[`role: MessageRole`](#MessageRole), `html: string`}

Object format used to encapsulate a message within the chat. One of the above is used for each message. <br />
