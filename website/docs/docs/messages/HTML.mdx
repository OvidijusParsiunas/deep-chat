...
Here is an example using [`initialMessages`](../messages#initialMessages):
...
chatElementRef.containerStyle = {height: '370px', borderRadius: '8px'};
...
Add a chart component (e.g. using [Google Chart](https://developers.google.com/chart)).
