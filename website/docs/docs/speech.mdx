...
:::info
If the [`microphone`](./files#microphone) recorder is set - this will not be enabled. <br />
:::
...
<ComponentContainer>
  <DeepChatBrowser
    demo={true}
    introMessage={"Azure Speech To Text can't be used in this website as you need to set your credentials."}
    containerStyle={{borderRadius: '8px'}}
    errorMessages={{
      overrides: {
...
<ComponentContainer>
  <DeepChatBrowser
    demo={true}
    introMessage={"Azure Speech To Text can't be used in this website as you need to set your region."}
    errorMessages={{
      overrides: {
...
<ComponentContainer>
  <DeepChatBrowser
    demo={true}
    introMessage={"Click the microphone to start transcribing your speech. Command mode activation phrase is 'command'."}
    containerStyle={{borderRadius: '8px'}}
    speechToText={{
      commands: {
        stop: 'stop',
...
- Type: {[`commandMode?: ButtonStyles`](./styles/#ButtonStyles), [`MicrophoneStyles`](./styles/#MicrophoneStyles)}

This object is used to define the styling for the microphone button. <br />
It contains the same properties as the [`MicrophoneStyles`](./styles/#MicrophoneStyles) object
