...
- Default: _{webSpeech: true, stopAfterSilenceMs: 25000 (25 seconds)}_
...
This object requires `region` and either `retrieveToken`, `subscriptionKey` or the `token` properties: <br />
`region` is the location/region of your speech resource. <br />
