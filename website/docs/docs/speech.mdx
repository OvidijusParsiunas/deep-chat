...
- Default: _{webSpeech: true, stopAfterSilenceMS: 25000}_
...
it can retrieve the token from a secure server that will hide your subscription key. Check out the [EXAMPLES](WORK) on how you can facilitate this. <br />
...
// WORK - potentially include a pause style
...
:::tip
You can use the [`CSSFilterConverter`](https://cssfilterconverter.com/) tool to generate filter values for the microphone icon color.
:::
