...
Alternatively, use the `simulation` object property to facilitate a <b>stream-like</b> experience for regular responses (incl. [websockets](HERE)). You can also control
