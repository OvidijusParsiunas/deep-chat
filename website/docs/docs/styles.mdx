...
<ComponentContainer>
  <DeepChatBrowser
    containerStyle={{backgroundColor: '#f7f7f7', borderRadius: '8px'}}
...
```html
<deep-chat containerStyle='{"backgroundColor": "#f7f7f7", "borderRadius": "8px"}'></deep-chat>
```
...
```html
<deep-chat attachmentContainerStyle='{"backgroundColor": "#76fffc57"}'></deep-chat>
```
