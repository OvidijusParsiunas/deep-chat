...
```html
<deep-chat containerStyle='{"backgroundColor": "#f7f7f7", "borderRadius": "15px"}'></deep-chat>
```
...
<deep-chat inputAreaStyle='{"backgroundColor": "#ebf5ff"}' existingService='{"demo": true}'></deep-chat>
```
...
- Type: {<br />
  &nbsp;&nbsp;&nbsp;&nbsp; `styles?:` {[`text?: CustomStyle`](#CustomStyle), [`container?: CustomStyle`](#CustomStyle)}, <br />
...
when a response message is being [`streamed`](./service#stream). <br />
