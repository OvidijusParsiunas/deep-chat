...
<ComponentContainer>
  <DeepChatBrowser
    ...
    directConnection={{demo: {displayFileAttachmentContainer: true}}}
...
<ComponentContainer>
  <DeepChatBrowser
    ...
    textInput={{
      styles: {
        text: {color: 'black'},
        container: {maxHeight: '50px', backgroundColor: '#f5f9ff', border: '1px solid #a2a2ff'},
      },
...
<deep-chat
  textInput='{
    "styles": {"text": {"color": "black"}, "container": {"maxHeight": "50px", "backgroundColor": "#f5f9ff", "border": "1px solid #a2a2ff"}},
    "placeholder": {"text": "Insert text here...", "style": {"color": "#4459a4"}},
    "characterLimit": 10
  }'
></deep-chat>
...
when a response message is being [`streamed`](./connect#stream). <br />
