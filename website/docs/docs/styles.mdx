...
<ComponentContainer>
  <DeepChatBrowser containerStyle={{backgroundColor: '#f7f7f7', borderRadius: '8px'}} demo={true}></DeepChatBrowser>
</ComponentContainer>
...
<deep-chat containerStyle='{"backgroundColor": "#f7f7f7", "borderRadius": "8px"}' demo="true"></deep-chat>
```
