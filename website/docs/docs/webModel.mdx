...
- Type: `true` | { <br />
  &nbsp;&nbsp;&nbsp;&nbsp; [`model?: string`](https://github.com/OvidijusParsiunas/deep-chat/blob/4449a91e26bb86d1d3a45633fd49c4dead3293d4/component/src/types/webModel/webModel.ts#L1), <br />
