...
`model` is the name of the model to be used. See [full list](https://github.com/OvidijusParsiunas/deep-chat/blob/4449a91e26bb86d1d3a45633fd49c4dead3293d4/component/src/types/webModel/webModel.ts#L1). <br />
...
Create a [`worker.js`](https://github.com/OvidijusParsiunas/deep-chat/blob/284bc845de8bcefe8ef36b2ee1b79079e6978593/website/docs/docs/worker.js) (or `worker.ts`) file in the same folder - which contains the following code:
