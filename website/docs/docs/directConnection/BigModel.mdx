...
Connect to BigModel's [Chat Completions API](https://docs.bigmodel.cn/api-reference/模型-api/对话补全). You can set this property to _true_ or configure it using an object: <br />
...
Connect to BigModel's [Image Generation API](https://docs.bigmodel.cn/api-reference/模型-api/图像生成). You can set this property to _true_ or configure it using an object: <br />
...
Connect to BigModel's [Audio Speech API](https://docs.bigmodel.cn/api-reference/模型-api/文本转语音). You can set this property to _true_ or configure it using an object: <br />
