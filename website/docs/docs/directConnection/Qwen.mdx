...
Connect to Alibaba Cloud's [Qwen API](https://www.alibabacloud.com/help/en/model-studio/use-qwen-by-calling-api). You can set this property to _true_ or configure it using an object:<br />
