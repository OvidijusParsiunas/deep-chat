...
Connect to Azure's [Text to Speech API](https://learn.microsoft.com/en-GB/azure/cognitive-services/speech-service/rest-text-to-speech?tabs=streaming#convert-text-to-speech). <br />
...
Connect to Azure's [Speech to Text API](https://learn.microsoft.com/en-gb/azure/cognitive-services/speech-service/rest-speech-to-text). <br />
`region` is a required string property to denote the region of your speech service, e.g. _"eastus"_. <br />
...
Connect to Azure's [Summarization API](https://learn.microsoft.com/en-us/azure/cognitive-services/language-service/summarization/overview?tabs=document-summarization). Please read [here](https://learn.microsoft.com/en-us/azure/cognitive-services/language-service/summarization/quickstart?tabs=document-summarization%2Cwindows&pivots=rest-api) how to generate a language service. <br />
...
Connect to Azure's [Translation API](https://learn.microsoft.com/en-gb/azure/cognitive-services/translator/reference/v3-0-reference). <br />
...
Connect to the [Azure OpenAI's API](https://platform.openai.com/docs/api-reference/chat): <br />
