...
Connect to X's [Chat API](https://docs.x.ai/docs/guides/chat). You can set this property to _true_ or configure it using an object: <br />
...
Connect to X's [Images Generation API](https://docs.x.ai/docs/guides/image-generations). You can set this property to _true_ or configure it using an object: <br />
