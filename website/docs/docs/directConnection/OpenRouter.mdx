...
Connect to OpenRouter's [Chat Completion API](https://openrouter.ai/docs/api-reference/chat-completion). You can set this property to _true_ or configure it using an object:<br />
