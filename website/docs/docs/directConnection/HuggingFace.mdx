...
Connect to Hugging Face [Conversational API](https://huggingface.co/docs/api-inference/detailed_parameters#conversational-task). <br />
...
Connect to Hugging Face [Text Generation API](https://huggingface.co/docs/api-inference/detailed_parameters#text-generation-task). <br />
`model` is the name of the model used for the task. <br />
`top_k` defines the top tokens considered within the sample operation to create new text. <br />
`top_p` is a float to define the tokens that are within the sample operation of text generation. Add tokens in the sample for more probable to least probable until the sum of the probabilities is greater than top \* p. <br />
`temperature` is a float (ranging from _0.0_ to _100.0_) temperature of the sampling operation. 1 means regular sampling, _0_ means always take the highest score, _100.0_ is getting closer to uniform probability. <br />
...
Connect to Hugging Face [Summarization API](https://huggingface.co/docs/api-inference/detailed_parameters#summarization-task). <br />
`model` is the name of the model used for the task. <br />
`min_length` is the minimum length in tokens of the output summary. <br />
`max_length` is the maximum length in tokens of the output summary. <br />
`top_k` defines the top tokens considered within the sample operation to create new text. <br />
...
Connect to Hugging Face [Translation API](https://huggingface.co/docs/api-inference/detailed_parameters#translation-task). <br />
`model` is the name of the model used for the task. <br />
`use_cache` is used to speed up requests by using the inference API cache.
...
Connect to Hugging Face [Fill Mask API](https://huggingface.co/docs/api-inference/detailed_parameters#fill-mask-task). <br />
`model` is the name of the model used for the task. <br />
`use_cache` is used to speed up requests by using the inference API cache.
...
Connect to Hugging Face [Question Answer API](https://huggingface.co/docs/api-inference/detailed_parameters#question-answering-task). <br />
...
Connect to Hugging Face [Audio Speech Recognition API](https://huggingface.co/docs/api-inference/detailed_parameters#automatic-speech-recognition-task). <br />
`model` is the name of the model used for the task. <br />
...
Connect to Hugging Face [Audio Classification API](https://huggingface.co/docs/api-inference/detailed_parameters#audio-classification-task). <br />
`model` is the name of the model used for the task. <br />
...
Connect to Hugging Face [Image Classification API](https://huggingface.co/docs/api-inference/detailed_parameters#image-classification-task). <br />
`model` is the name of the model used for the task. <br />
