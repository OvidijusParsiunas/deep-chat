...
Connect to Groq's [Chat Completions API](https://console.groq.com/docs/api-reference#chat-create). You can set this property to _true_ or configure it using an object: <br />
...
Connect to Groq's [audio speech API](https://console.groq.com/docs/api-reference#audio-speechCalled). You can set this property to _true_ or configure it using an object: <br />
