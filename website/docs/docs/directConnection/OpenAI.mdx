...
`assistant_id` is the id of your assistant. To create a new one - please go to the official [OpenAI assistants platform](https://platform.openai.com/assistants). <br />
