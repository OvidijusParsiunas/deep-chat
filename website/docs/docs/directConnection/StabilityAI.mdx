...
# <img src={stabilityAILogo} width="48" style={{float: 'left', marginTop: '5px', marginRight: '6px', marginLeft: '2px'}} /> StabilityAI

Properties used to connect to [StabilityAI](https://platform.stability.ai/).
...
- Default: _{engine_id: "stable-diffusion-v1-5", width: 512, height: 512}_
...
- Type: { <br />
  &nbsp;&nbsp;&nbsp;&nbsp; _engine_id: "stable-diffusion-v1-5"_, <br />
...
- Default: _{engine_id: "stable-inpainting-512-v2-0", mask_source: "MASK_IMAGE_WHITE"}_
...
- Default: _{engine_id: "stable-diffusion-v1-5"}_
  ...
  <ComponentContainer>
    <DeepChatBrowser
      ...
      directConnection={{
        stabilityAI: {
          key: 'placeholder key',
          textToImage: {engine_id: 'stable-diffusion-v1-5', weight: 1, style_preset: 'fantasy-art', samples: 2},
        },
      }}
    ></DeepChatBrowser>
  </ComponentContainer>
