...
- Type: `true` | \{<br />
  ...
  \}
- Default: _\{model: "gemini-2.5-flash"\}_
...
Connect to Google AI's [generateContent API](https://ai.google.dev/api/rest/v1beta/models/generateContent). You can set this property to _true_ or configure it using an object:<br />
