...
Connect to Moonshot AI's [Chat Completion API](https://platform.moonshot.ai/docs/api/chat#chat-completion). You can set this property to _true_ or configure it using an object:<br />
