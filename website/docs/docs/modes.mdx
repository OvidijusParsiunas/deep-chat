...
<ComponentContainer>
  <DeepChatBrowser style={{borderRadius: '8px'}} focusMode={{smoothScroll: true}} demo={true}></DeepChatBrowser>
</ComponentContainer>
...
```html
<deep-chat focusMode='{"smoothScroll": true}'></deep-chat>
```
...
<deep-chat focusMode='{"smoothScroll": true}' demo="true" style="border-radius: 8px"></deep-chat>
```
...
### `upwardsMode` {#upwardsMode}

- Type: `boolean`

This mode displays messages from bottom to top.

#### Example

<ComponentContainer>
  <DeepChatBrowser style={{borderRadius: '8px'}} upwardsMode={true} demo={true}></DeepChatBrowser>
</ComponentContainer>
...
```html
<deep-chat upwardsMode="true"></deep-chat>
```
...
<deep-chat upwardsMode="true" demo="true" style="border-radius: 8px"></deep-chat>
```
