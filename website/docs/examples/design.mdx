...
This example simulates the styling used in [ChatGPT](https://chat.openai.com/).
...
// WORK - Change microphone button to speech to text.

### Bard {#bard}

Simulation of the styling used in [Google Bard](https://bard.google.com/).
...
<deep-chat
  containerStyle='{"borderRadius": "10px", "borderColor": "#dcdcdc", "backgroundColor": "#f3f6fc"}'
  textInput='{
    "styles": {
  ...
  avatars='{
    ...
    "ai": {"src": "path-to-file.png", "styles": {"position": "left", "avatar": {"paddingTop": "6px"}}}
  }'
  microphone='{
    "button": {
      "default": {
