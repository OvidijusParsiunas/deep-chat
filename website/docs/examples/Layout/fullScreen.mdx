...
Examples to help you expand the chat component dimensions. The trick is to simply set the [`containerStyle`](../../docs/styles#containerStyle) property to the dimensions you desire and set the _fontSize_
which will control the size of the elements.
