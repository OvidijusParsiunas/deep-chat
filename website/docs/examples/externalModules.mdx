...
- <b>Script from a CDN</b> <br />
  ...
  | [web model](https://github.com/OvidijusParsiunas/web-llm)                      | const script = document.createElement('script'); <br /> script.src = 'https://aka.ms/csspeech/jsbrowserpackageraw'; <br /> document.body.appendChild(script);                                                                                                                                          |
