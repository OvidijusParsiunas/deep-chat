...
function ComponentPanel() {
  ...
  return (
    <div id="start-panel-animation-content-container">
      ...
      <div
        id="message-bubble"
        style={{left: '427px', backgroundColor: '#0084ff'}}
        className={'displayed'}
        ref={messageBubble}
      ></div>
    </div>
...
export default function StartPanel() {
  return (
    <BrowserOnly>
      {() => {
        return (
          <div id="start-panel" style={{background: 'white'}}>
            <div
              id="media-diagonal-padding"
              style={{transform: 'skewY(-3deg)', marginTop: '220px', height: '300px', position: 'absolute', width: '100%'}}
            ></div>
